...
var articles={
    'article-one' : {
        ...
        content : `
                    ...
                    <img src="https://github.com/yash627/imad-2016-app/blob/master/images/pic_2.jpg?raw=true" class="img-about"/>
    ...
    'article-three' : { title : 'Article Three | Yash Khurana',
        ...
        content : `
                    <p>
                        <img src="https://team.sdslabs.co/assets/email.png" class="contact"/>: <a href = mailto@y.khurana@rediffmail.com>Yash Khurana </a>
                    </p>`}
};
